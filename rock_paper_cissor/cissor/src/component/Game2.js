...
class Game2 extends React.Component {
    ...
    recuperation = (resultat) => {
        this.props.onRecuperation(resultat)
    }
    ...
    plop = () => {
        ...
        if (this.props.modif == 'modifButton' && this.random == 3) {
            this.h2 = "YOU LOSE"
            this.recuperation("YOU LOSE")
        }
        else if (this.props.modif == 'modifButton' && this.random == 2) {
            this.h2 = "YOU WIN"
            this.recuperation("YOU WIN")
        }
        else if (this.props.modif == 'modifButton' && this.random == 1) {
            this.h2 = "DRAW"
            this.recuperation("DRAW")
        }
        else if (this.props.modif == 'modifButton2' && this.random == 2) {
            this.h2 = "DRAW"
            this.recuperation("DRAW")
        }
        else if (this.props.modif == 'modifButton2' && this.random == 3) {
            this.h2 = "YOU WIN"
            this.recuperation("YOU WIN")
        }
        else if (this.props.modif == 'modifButton2' && this.random == 1) {
            this.h2 = "YOU LOSE"
            this.recuperation("YOU LOSE")
        }
        else if (this.props.modif == 'modifButton3' && this.random == 1) {
            this.h2 = "YOU WIN"
            this.recuperation("YOU WIN")
        }
        else if (this.props.modif == 'modifButton3' && this.random == 2) {
            this.h2 = "YOU LOSE"
            this.recuperation("YOU LOSE")
        }
        else if (this.props.modif == 'modifButton3' && this.random == 3) {
            this.h2 = "DRAW"
            this.recuperation("DRAW")
        }

        this.recuperation(this.h2)
    };
